 ...
 *
 * Ice Rage links its own copy of libgcc's ARM unwinder, so throwing is
 ...
 * libicerage.so is not in that list and never can be: this loader mapped it
 ...
 *
 * That is exactly how Ice Rage was dying at M4. xt::TextureLoader::loadTexture2D
...
extern "C" uintptr_t icerage_unwind_find_exidx(uintptr_t pc, int *pcount)
{
...
DynLibFunction symtable_unwind[] = {
    ...
    NO_THUNK("__gnu_Unwind_Find_exidx", (uintptr_t)&icerage_unwind_find_exidx),
#endif
    { NULL, 0 },
};
